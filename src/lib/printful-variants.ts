...
export const PRINT_FILE_URLS: Record<string, { print?: string; tee?: string }> = {
  ...
  'ice-cave':              { print: `${BASE_PRINT_FILES_URL}/ice-cave-print.jpg`,              tee: `${BASE_PRINT_FILES_URL}/ice-cave-tee.png` },
  'mountain-series-1':     { print: `${BASE_PRINT_FILES_URL}/mountain-series-1-print.jpg`,     tee: `${BASE_PRINT_FILES_URL}/mountain-series-1-tee.png` },
  // Add remaining slugs as Mikey provides high-res files
};
